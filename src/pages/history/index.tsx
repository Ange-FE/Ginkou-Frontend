  ...
  return (
    <CenteredLayout className={className} maxWidth={2000}>
      ...
      <PaddingSection className="introductory-text" padding="20px 30px" style={{margin: "10px 30px 50px 30px"}}>
        You will find in this section a little history about Ginkou, Ginkou is a copy of cavern Protocol, which at the time of writing exists on Terra Luna blockchain and is working 
        in partnership with Toxic Labs Dao to bring utility to the Terra Luna Classic blockchain, as well as the future orientations the protocol will take. 
        <br/>
        ...
        <br/>
        <br/>
        This is what you could call our <strong>Whitepaper</strong>. Below is the original white paper by Cavern Protocol we at Toxic Labs wish to pay 
        homage to Ginkou founding project <strong><a href="https://cavernprotocol.com/">Cavern Protocol</a></strong> as such we havent changed the orignal white paper text
      </PaddingSection>
